...
<head>
    ...
    <script>
        ...
        async function loadGeoJsonData() {
            const response = await fetch("/js/neighborhoods.geojson");
...
<body>
    ...
    <script>
        ...
        var map = L.map('map').setView([41.8831, -87.6521], 13);

        var token = '<%= application.getAttribute("thunderforestToken") %>';
        var mapTileSource = 'https://tile.thunderforest.com/neighbourhood/{z}/{x}/{y}.png?apikey=' + token;
